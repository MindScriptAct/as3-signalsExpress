...
public class SimpleTestMain extends Sprite {
	...
	private function init(e:Event = null):void {
		...
		var sender7:Sender = new Sender("D:\nNothing should happen.\n listener removed.", 0xaaaaaa);
		addChild(sender7);
		sender7.x = 500;
		sender7.y = 500;

		sender7.clicked.add(sholdNotHandle);
		sender7.clicked.remove(sholdNotHandle);
	...
	private function sholdNotHandle(event:MouseEvent):void {
		trace("ERROR! this handler sholud be removed!!!");
	}
