...
import performanceCheck.starlingExpress.PerfStarlingExpressRoot;
...
public class PerfarmanceCheckStarlingExpressMain extends Sprite {
	...
	public function PerfarmanceCheckStarlingExpressMain() {
		...
		_starling = new Starling(PerfStarlingExpressRoot, stage);
		_starling.start();
	}
}
}
